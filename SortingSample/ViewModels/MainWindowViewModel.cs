...
namespace SortingSample.ViewModels
{
	public class MainWindowViewModel : ViewModel
	{
		...
		SortDrawer drawer = new SortDrawer();

		public SortingMethod Method
		{
			get { return drawer.Method; }
			set { drawer.Method = value; }
		}

		public SortingMethod[] AvailableMethods { get { return (SortingMethod[])Enum.GetValues(typeof(SortingMethod)); } }
		...
		public ViewModelCommand SortCommand
		{
			get
			{
